...
言い換えタスクに新手法を導入した研究. まず入力文を構文解析し, その構文木をencoder-decoderによって組み替える. 次に入力文の語順をどのように入れ替えれば組み替え後の構文木が実現されるかを割り出し, positional embeddingをそのように入れ替えてTransformerベースのencoder-decoderに入力文を与えるアプローチをとった
